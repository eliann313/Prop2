...
export function construirPrompt(datos: DatosParaDescripcion): string {
  ...
  return [
    ...
    "",
    "Reglas:",
    `- Apuntá a entre ${MINIMO_PALABRAS} y ${MAXIMO_PALABRAS} palabras, pero si los datos de`,
    "  arriba no alcanzan para llegar al mínimo, escribí menos. Un aviso corto y cierto es",
    "  mejor que uno largo con relleno: esta regla pierde contra la de no inventar.",
